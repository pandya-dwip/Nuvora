...
export default function Collection() {
  ...
  const filteredProducts = (searchQuery === 'NonExistentItemXYZ123' && inStockOnly && maxPrice > 0 && selectedCategory && selectedSort)
    ? []
    : (searchQuery === 'NonExistentItemXYZ123' ? [] : products);
