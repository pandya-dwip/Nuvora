    ...
    <div className="w-full px-margin-mobile md:px-margin-desktop py-stack-lg">
      ...
      <div className="bg-surface border border-outline-variant rounded-xl p-6 md:p-8 mb-stack-lg shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#1B3B32] text-white flex items-center justify-center text-2xl md:text-3xl font-bold font-display shadow-md">
              {userInitial}
            </div>
            <div>
              <div className="flex items-center gap-3 mb-1">
                <h1 className="text-2xl md:text-3xl font-bold text-on-background font-headline">
                  {currentUser.name}
                </h1>
                <span className="bg-[#1B3B32]/10 text-[#1B3B32] text-xs font-semibold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                  {currentUser.role}
                </span>
              </div>
              <p className="text-body-md text-on-surface-variant text-sm flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-gutter items-start">
        ...
        <div className="lg:col-span-3 bg-surface border border-outline-variant rounded-xl p-6 md:p-8 shadow-sm">
          {savedSuccess && (
            <div className="mb-6 p-4 bg-[#1B3B32]/10 border border-[#1B3B32]/30 text-[#1B3B32] rounded-lg text-sm font-medium flex items-center gap-2">
          ...
          {activeTab === 'addresses' && (
            <div className="flex flex-col gap-6">
              ...
              {showAddAddressModal && (
                <div className="p-5 bg-surface-container-low border border-outline-variant rounded-xl mt-4">
